...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 12 Avril 2015 à 17:59
...
INSERT INTO `formation` (`form_id`, `form_libelle`, `form_date_debut`, `form_date_fin`, `form_lieu`, `form_prerequis`, `form_cout_credit`, `prest_id`) VALUES
(1, 'Ninja 101', '2015-02-02', '2015-02-04', 'Tijuana', 'Que nenni', 150, 1),
(2, 'Formation nulle', '2015-04-15', '2015-04-16', 'Loin', 'Rien', 325, 1),
(3, 'Formation pourrie', '2015-04-01', '2015-04-04', 'Loin', 'Rien', 124, 1),
(4, 'Formation inutile', '2015-04-26', '2015-04-28', 'Loin', 'Rien', 1, 1),
(5, 'Formation kikoo', '2015-04-14', '2015-04-30', 'N''importe où', 'Osef', 3782, 1);
